...
static const char autostartsh[]          = "~/.config/dwm-flexipatch/autostart.sh";
static const char dwmdir[]               = "~/.config/dwm-flexipatch";
static const char localshare[]           = "~/.local/share";
#endif // AUTOSTART_PATCH
#if BAR_ANYBAR_PATCH
static const int usealtbar               = 1;        /* 1 means use non-dwm status bar */
static const char *altbarclass           = "Polybar"; /* Alternate bar class name */
static const char *altbarcmd             = "$HOME/.config/polybar/awesome.sh"; /* Alternate bar launch command */
...
static const char *roficmd[] = { "rofi", "-dpi", "1.25", "-show", "drun", "-show-icons", NULL };
